...
/**
 * @author Alexandre Blansché Programme principal
 */
public final class Main extends OutputWriter {
    ...
    private void loadBots() {
        ...
        // compétition
        // Set <Class <? extends CompetitorBot>> subClassesTmp =
        // reflections.getSubTypesOf (CompetitorBot.class);
        Set<Class<? extends DemoBot>> subClassesTmp = reflections.getSubTypesOf(DemoBot.class);
        // Set <Class <? extends Bot>> subClassesTmp = reflections.getSubTypesOf
        // (Bot.class);
